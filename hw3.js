...
//     var newArr = [];
//     for (let i = 0; i < arr.length; i++) {
//         newArr = arr.concat(1,2,3);
//     }
//     return newArr;
//  } 
//
//  function doubleArray1(arr) {
//     return arr.concat(arr).concat(arr).join().split(',')
//  }
...
// console.log(result);  
// result = changeCollection([1,2,3]);
// console.log(result);  
// result = changeCollection([1,2,3],['a','b','c'],['a','b','c']);
// console.log(result);  
//-------------------------------------------
//
// задача 1
